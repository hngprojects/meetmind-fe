...
import {
  blogPostImage,
  quoteIcon,
} from '@/components/common/LandingPage/assets';
      ...
      <main className="pt-24 pb-16">
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-6 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
            ...
            {/* Quote Block */}
            <div className="relative py-16 mb-12 border-t border-b border-gray-100 flex flex-row items-start gap-4 md:gap-8 px-4">
              {/* The Quote Icon */}
              <img
                src={quoteIcon}
                alt=""
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold text-[#000000] mb-6 uppercase tracking-wider">
                SOLUTION
              </h2>
              <p>
